...
\titol{Plataforma IoT oberta per a projectes de ciència ciutadana: solucions de connectivitat}

%% Titol del document en anglès (Per l'apartat overview)
\titolE{IoT platform open for citizen science projects: connectivity solutions}

%% Titol del document en catala/castella (Per l'apartat resum)
\titolC{Plataforma IoT oberta per a projectes de ciència ciutadana: solucions de connectivitat}
...
\textDedicatoria{Dedicat a totes aquelles persones que han estat part del meu recorregut universitari.}
